...
public class MenuTestData {
    ...
    public static final Menu menu3 = new Menu(FIRST_MENU_ID + 2, third_restaurant, LocalDate.of(2021, 9, 2), dish4);
    ...
    public static Menu getUpdated() {
        return new Menu(FIRST_MENU_ID + 6, third_restaurant, LocalDate.of(2021, 9, 10), DishTestData.getUpdated());
    }
}
