...
public class MenuUtil {
    ...
    public static MenuTo menuAsTo(Menu menu) {
        return new MenuTo(menu.getId(), menu.getRestaurant(), menu.getDate(), menu.getDish());
    }

    public static Menu menuToAsMenu(MenuTo menuTo) {
        return new Menu(menuTo.getId(), menuTo.getRestaurant(), menuTo.getDate(), menuTo.getDish());
    }
